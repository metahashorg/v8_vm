...
// NOTE: On Windows systems we should use 'wchar_t' but V8 doesn't support it.
//       If you want to use the sources into other projects to rewrite sources
//       taking it into account. (See Chromium sources)
//       Because of this reason comments below weren't changed.
...
#ifndef V8_VM_UTILS_FILE_PATH_H_
#define V8_VM_UTILS_FILE_PATH_H_
...
// #endif  // OS_WIN
  ...
  typedef StringType StringPiece;
  typedef StringType StringPieceType;
  ...
  explicit FilePath(const StringPieceType& path);
  ~FilePath();
  ...
  FilePath DirName() const V8_WARN_UNUSED_RESULT;

  // Returns a FilePath corresponding to the last path component of this
  // object, either a file or a directory.  If this object already refers to
  // the root directory, returns a FilePath identifying the root directory;
  // this is the only situation in which BaseName will return an absolute path.
  FilePath BaseName() const V8_WARN_UNUSED_RESULT;
  ...
  StringType Extension() const V8_WARN_UNUSED_RESULT;
  ...
  StringType FinalExtension() const V8_WARN_UNUSED_RESULT;

  // Returns "C:\pics\jojo" for path "C:\pics\jojo.jpg"
  // NOTE: this is slightly different from the similar file_util implementation
  // which returned simply 'jojo'.
  FilePath RemoveExtension() const V8_WARN_UNUSED_RESULT;

  // Removes the path's file extension, as in RemoveExtension(), but
  // ignores double extensions.
  FilePath RemoveFinalExtension() const V8_WARN_UNUSED_RESULT;
  ...
  FilePath InsertBeforeExtension(
      StringPieceType suffix) const V8_WARN_UNUSED_RESULT;
  FilePath InsertBeforeExtensionASCII(
      StringPiece suffix) const V8_WARN_UNUSED_RESULT;

  // Adds |extension| to |file_name|. Returns the current FilePath if
  // |extension| is empty. Returns "" if BaseName() == "." or "..".
  FilePath AddExtension(StringPieceType extension) const V8_WARN_UNUSED_RESULT;
  ...
  FilePath Append(StringPieceType component) const V8_WARN_UNUSED_RESULT;
  FilePath Append(const FilePath& component) const V8_WARN_UNUSED_RESULT;
  ...
  FilePath AppendASCII(StringPiece component) const V8_WARN_UNUSED_RESULT;
  ...
  bool EndsWithSeparator() const V8_WARN_UNUSED_RESULT;

  // Returns a copy of this FilePath that ends with a trailing separator. If
  // the input path is empty, an empty FilePath will be returned.
  FilePath AsEndingWithSeparator() const V8_WARN_UNUSED_RESULT;

  // Returns a copy of this FilePath that does not end with a trailing
  // separator.
  FilePath StripTrailingSeparators() const V8_WARN_UNUSED_RESULT;
...
template <>
struct hash<v8::vm::internal::FilePath> {
  typedef v8::vm::internal::FilePath argument_type;
  typedef std::size_t result_type;
  result_type operator()(argument_type const& f) const {
    return hash<v8::vm::internal::FilePath::StringType>()(f.value());
  }
};

}  // namespace std

#endif  // V8_VM_UTILS_FILE_PATH_H_
