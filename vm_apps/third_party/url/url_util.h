...
URL_EXPORT bool FindAndCompareScheme(const wchar_t* str,
                                     int str_len,
                                     const char* compare,
                                     Component* found_scheme);
...
URL_EXPORT bool IsStandard(const wchar_t* spec, const Component& scheme);
...
URL_EXPORT bool DomainIs(std::string canonical_host,
...
URL_EXPORT bool HostIsIPAddress(std::string host);
...
URL_EXPORT bool Canonicalize(const wchar_t* spec,
                             int spec_len,
                             bool trim_path_end,
                             CharsetConverter* charset_converter,
                             CanonOutput* output,
