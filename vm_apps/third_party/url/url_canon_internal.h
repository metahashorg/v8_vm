...
URL_EXPORT bool ReadUTFChar(const wchar_t* str, int* begin, int length,
                            unsigned* code_point_out);
...
inline bool AppendUTF8EscapedChar(const wchar_t* str, int* begin,
...
// normal.
URL_EXPORT bool ConvertUTF16ToUTF8(const wchar_t* input, int input_len,
                                   CanonOutput* output);
...
URL_EXPORT int _itoa_s(int value, char* buffer, size_t size_in_chars,
                       int radix);
URL_EXPORT int _itow_s(int value, wchar_t* buffer, size_t size_in_chars,
                       int radix);
