...
URL_EXPORT void ParseStandardURL(const char* url,
                                 int url_len,
                                 Parsed* parsed);
URL_EXPORT void ParseStandardURL(const wchar_t* url,
                                 int url_len,
                                 Parsed* parsed);
...
URL_EXPORT void ParsePathURL(const char* url,
                             ...
                             bool trim_path_end,
                             Parsed* parsed);
URL_EXPORT void ParsePathURL(const wchar_t* url,
                             int url_len,
                             bool trim_path_end,
                             Parsed* parsed);
...
URL_EXPORT void ParseFileURL(const wchar_t* url,
                             int url_len,
                             Parsed* parsed);
...
URL_EXPORT void ParseFileSystemURL(const char* url,
                                   int url_len,
                                   Parsed* parsed);
URL_EXPORT void ParseFileSystemURL(const wchar_t* url,
                                   int url_len,
                                   Parsed* parsed);

// MailtoURL is for mailto: urls. They are made up scheme,path,query
URL_EXPORT void ParseMailtoURL(const char* url, int url_len, Parsed* parsed);
URL_EXPORT void ParseMailtoURL(const wchar_t* url,
                               int url_len,
                               Parsed* parsed);
...
URL_EXPORT bool ExtractScheme(const char* url,
                              int url_len,
                              Component* scheme);
URL_EXPORT bool ExtractScheme(const wchar_t* url,
                              int url_len,
                              Component* scheme);

// Returns true if ch is a character that terminates the authority segment
// of a URL.
URL_EXPORT bool IsAuthorityTerminator(wchar_t ch);
...
URL_EXPORT void ParseAuthority(const char* spec,
                               ...
                               Component* hostname,
                               Component* port_num);
URL_EXPORT void ParseAuthority(const wchar_t* spec,
                               const Component& auth,
                               Component* username,
                               Component* password,
                               Component* hostname,
...
URL_EXPORT int ParsePort(const wchar_t* url, const Component& port);
...
URL_EXPORT void ExtractFileName(const char* url,
                                ...
                                Component* file_name);
URL_EXPORT void ExtractFileName(const wchar_t* url,
                                const Component& path,
                                Component* file_name);
...
URL_EXPORT bool ExtractQueryKeyValue(const char* url,
                                     ...
                                     Component* key,
                                     Component* value);
URL_EXPORT bool ExtractQueryKeyValue(const wchar_t* url,
                                     Component* query,
                                     Component* key,
                                     Component* value);
