...
URL_EXPORT bool FindIPv4Components(const wchar_t* spec,
                                   const Component& host,
                                   Component components[4]);
...
URL_EXPORT CanonHostInfo::Family IPv4AddressToNumber(const wchar_t* spec,
                                                     const Component& host,
                                                     unsigned char address[4],
                                                     int* num_ipv4_components);
...
URL_EXPORT bool IPv6AddressToNumber(const wchar_t* spec,
                                    const Component& host,
                                    unsigned char address[16]);
