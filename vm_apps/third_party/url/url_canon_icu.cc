...
#include "vm_apps/third_party/url/url_canon_icu.h"
#include "vm_apps/third_party/url/url_canon_internal.h"  // for _itoa_s
...
// static v8::base::LazyInstance<UIDNAWrapper>::type
//     g_uidna = LAZY_INSTANCE_INITIALIZER;
// struct {
//   UIDNAWrapper& Get() {
//     if (!pointer) {
//       pointer = new UIDNAWrapper() ;
//     }
//
//     return *pointer ;
//   }
//
//   UIDNAWrapper* pointer = nullptr ;
// } g_uidna ;
