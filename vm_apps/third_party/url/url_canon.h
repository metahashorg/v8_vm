...
// @metahash #include "base/strings/string16.h"
#include "vm_apps/third_party/url/third_party/mozilla/url_parse.h"
#include "vm_apps/third_party/url/url_export.h"
...
URL_EXPORT const wchar_t* RemoveURLWhitespace(
    const wchar_t* input,
    int input_len,
...
URL_EXPORT bool IDNToASCII(const wchar_t* src,
                           int src_len,
                           CanonOutputW* output);
...
URL_EXPORT bool CanonicalizeScheme(const wchar_t* spec,
                                   const Component& scheme,
                                   CanonOutput* output,
                                   Component* out_scheme);
...
URL_EXPORT bool CanonicalizeUserInfo(const wchar_t* username_source,
                                     const Component& username,
...
URL_EXPORT bool CanonicalizeHost(const char* spec,
                                 ...
                                 CanonOutput* output,
                                 Component* out_host);
URL_EXPORT bool CanonicalizeHost(const wchar_t* spec,
                                 const Component& host,
                                 CanonOutput* output,
                                 Component* out_host);
...
URL_EXPORT void CanonicalizeHostVerbose(const wchar_t* spec,
                                        const Component& host,
                                        CanonOutput* output,
                                        CanonHostInfo* host_info);
...
URL_EXPORT bool CanonicalizeHostSubstring(const char* spec,
                                          const Component& host,
                                          CanonOutput* output);
URL_EXPORT bool CanonicalizeHostSubstring(const wchar_t* spec,
                                          const Component& host,
                                          CanonOutput* output);
...
URL_EXPORT void CanonicalizeIPAddress(const char* spec,
                                      ...
                                      CanonOutput* output,
                                      CanonHostInfo* host_info);
URL_EXPORT void CanonicalizeIPAddress(const wchar_t* spec,
                                      const Component& host,
                                      CanonOutput* output,
                                      CanonHostInfo* host_info);
...
URL_EXPORT bool CanonicalizePort(const char* spec,
                                 ...
                                 CanonOutput* output,
                                 Component* out_port);
URL_EXPORT bool CanonicalizePort(const wchar_t* spec,
                                 const Component& port,
                                 int default_port_for_scheme,
                                 CanonOutput* output,
                                 Component* out_port);
...
URL_EXPORT bool CanonicalizePath(const char* spec,
                                 ...
                                 CanonOutput* output,
                                 Component* out_path);
URL_EXPORT bool CanonicalizePath(const wchar_t* spec,
                                 const Component& path,
                                 CanonOutput* output,
                                 Component* out_path);
...
URL_EXPORT bool FileCanonicalizePath(const char* spec,
                                     ...
                                     CanonOutput* output,
                                     Component* out_path);
URL_EXPORT bool FileCanonicalizePath(const wchar_t* spec,
                                     const Component& path,
                                     CanonOutput* output,
                                     Component* out_path);
...
URL_EXPORT void CanonicalizeQuery(const char* spec,
                                  ...
                                  CanonOutput* output,
                                  Component* out_query);
URL_EXPORT void CanonicalizeQuery(const wchar_t* spec,
                                  const Component& query,
                                  CharsetConverter* converter,
                                  CanonOutput* output,
                                  Component* out_query);
...
URL_EXPORT void CanonicalizeRef(const char* spec,
                                ...
                                CanonOutput* output,
                                Component* out_path);
URL_EXPORT void CanonicalizeRef(const wchar_t* spec,
                                const Component& path,
                                CanonOutput* output,
                                Component* out_path);
...
URL_EXPORT bool CanonicalizeStandardURL(const char* spec,
                                        ...
                                        CanonOutput* output,
                                        Parsed* new_parsed);
URL_EXPORT bool CanonicalizeStandardURL(const wchar_t* spec,
                                        int spec_len,
                                        const Parsed& parsed,
                                        CharsetConverter* query_converter,
                                        CanonOutput* output,
...
URL_EXPORT bool CanonicalizeFileURL(const char* spec,
                                    ...
                                    CanonOutput* output,
                                    Parsed* new_parsed);
URL_EXPORT bool CanonicalizeFileURL(const wchar_t* spec,
                                    int spec_len,
                                    const Parsed& parsed,
                                    CharsetConverter* query_converter,
                                    CanonOutput* output,
...
URL_EXPORT bool CanonicalizeFileSystemURL(const char* spec,
                                          ...
                                          CanonOutput* output,
                                          Parsed* new_parsed);
URL_EXPORT bool CanonicalizeFileSystemURL(const wchar_t* spec,
                                          int spec_len,
                                          const Parsed& parsed,
                                          CharsetConverter* query_converter,
                                          CanonOutput* output,
...
URL_EXPORT bool CanonicalizePathURL(const char* spec,
                                    ...
                                    CanonOutput* output,
                                    Parsed* new_parsed);
URL_EXPORT bool CanonicalizePathURL(const wchar_t* spec,
                                    int spec_len,
                                    const Parsed& parsed,
                                    CanonOutput* output,
                                    Parsed* new_parsed);
...
URL_EXPORT bool CanonicalizeMailtoURL(const char* spec,
                                      ...
                                      CanonOutput* output,
                                      Parsed* new_parsed);
URL_EXPORT bool CanonicalizeMailtoURL(const wchar_t* spec,
                                      int spec_len,
                                      const Parsed& parsed,
                                      CanonOutput* output,
                                      Parsed* new_parsed);
